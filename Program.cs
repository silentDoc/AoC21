...
namespace AoC21
{
    internal class Program
    {
        ...
        {
            var lines = File.ReadAllLines(input).ToList();
            Day17.ProbeLauncher daySolver = new();
            daySolver.ParseInput(lines);
            return daySolver.Solve(part).ToString();
        }
        ...
        {
            var lines = File.ReadAllLines(input).ToList();
            Day18.SnailfishSolver daySolver = new();
            daySolver.ParseInput(lines);
            return daySolver.Solve(part).ToString();
        }
        ...
        {
            var lines = File.ReadAllLines(input).ToList();
            Day19.BeaconScanner daySolver = new();
            daySolver.ParseInput(lines);
            return daySolver.Solve(part).ToString();
        }
        ...
        {
            var lines = File.ReadAllLines(input).ToList();
            Day20.ImageEnhancer daySolver = new();
            daySolver.ParseInput(lines);
            return  daySolver.Solve(part).ToString();
        }
        ...
        {
            var lines = File.ReadAllLines(input).ToList();
            Day23.AmphiMover daySolver = new();
            daySolver.ParseInput(lines);
            return  daySolver.Solve(part).ToString();
        }
        ...
        {
            var lines = File.ReadAllLines(input).ToList();
            Day25.CucumberNavi daySolver = new();
            daySolver.ParseInput(lines);
            return daySolver.Solve(part).ToString();
        }
    }
